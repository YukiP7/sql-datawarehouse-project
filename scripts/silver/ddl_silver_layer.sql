...
-- start data ingestion in silver layer 
...
CREATE TABLE silver.crm_cust_info(
	...
	dwh_create_date DATETIME2 DEFAULT GETDATE() -- metadata(extra data which is added by data engineers for their reference);
);
